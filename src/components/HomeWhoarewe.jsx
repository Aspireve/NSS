...
// import  whoarewe  from "../staticData/home-whoarewe.json"
...
export default function WhoAreWe() {
  ...
  return (
    <section className={`about-us ${isVisible? "appear" : ""}`} ref={aboutUsTitleRef}>
      <div className="nss-logo-container image-wrapper">
        <img src={nss_logo} alt="NSS LOGO" loading="lazy"/>
      </div>
      <div className="about-us-text">
        <h2 className={isVisible? "about-us-text-header" : ""} id="about-us-text-header" ref={sliderRef}>Who Are We</h2>
